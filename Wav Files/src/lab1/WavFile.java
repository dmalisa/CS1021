...
public class WavFile {
     ...
     * @param numChannels The number of channels of audio. If more than one, the samples are
     *                    interleaved.
     * @param numFrames The number of frames of audio
     * @param validBits The number of valid bits, that is, how many bits are used to specify the
     *                  amplitude of each sample, e.g., 16 bits.
     * @param sampleRate The sample rate for the audio samples in samples per second (Hz). Typical
     *                   sample rates are 44,100 Hz, 32,000 Hz, 22,050 Hz, 11,025 Hz, and 8,000 Hz.
     */
